        ...
        <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <div class="mb-2">
                        <img src="{{ asset('storage/' . $user->profile_photo) }}" alt="Profile" style="max-height: 100px;" class="rounded">
                    </div>
                    @endif
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" value="{{ old('nama', $teacher->nama ?? '') }}">
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <div class="mb-2">
                        <img src="{{ asset('storage/' . $teacher->photo) }}" alt="Foto Guru" style="max-height: 100px;" class="rounded">
                    </div>
                    @endif
