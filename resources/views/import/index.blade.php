                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-sm btn-outline-danger" data-bs-toggle="modal" data-bs-target="#errorModal{{ $import->id }}">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <ul class="list-unstyled">
                                                ...
                                                <li class="text-danger"><i class="ti ti-x"></i> {{ $error }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </div>
