            ...
            <div class="card border-0 shadow-sm h-100">
                            ...
                            <li class="list-group-item d-flex align-items-center px-4 py-3 border-0">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <span class="badge bg-light-secondary text-muted"
                                        style="font-size: 10px;">{{ $student->kelas }}</span>
                                </div>
                                <a href="{{ route('guru.mutabaah.student-calendar', $student->id) }}"
                                    class="btn btn-icon btn-light-danger btn-sm rounded-circle">
                                    <i class="ti ti-eye"></i>
                                </a>
                            </li>
                        @empty
                            <div class="text-center py-5">
                                ...
                                <p class="text-muted small">Alhamdulillah, semua siswa aktif!</p>
                            </div>
                        @endforelse
                    </ul>
                </div>
                @if ($inactiveStudents->count() > 0)
                    <div class="card-footer bg-transparent border-0 text-center pb-4">
                        <a href="{{ route('guru.student.index') }}"
                            class="btn btn-link btn-sm text-danger text-decoration-none fw-bold">Follow up semua siswa</a>
                    </div>
                @endif
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-8 mb-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <a href="{{ route('guru.classroom.index') }}" class="btn btn-sm btn-link text-decoration-none">Kelola
                    Kelas</a>
            </div>
            <div class="row">
                        ...
                        <div class="card border-0 shadow-sm h-100 overflow-hidden">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-start mb-3">
                                    ...
                                    <div class="dropdown">
                                        <button class="btn btn-icon btn-link-secondary dropdown-toggle arrow-none"
                                            data-bs-toggle="dropdown">
                                            <i class="ti ti-dots-vertical"></i>
                                        </button>
                                        <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0">
                                            <li><a class="dropdown-item"
                                                    href="{{ route('guru.student.index', ['kelas' => $class->nama]) }}"><i
                                                        class="ti ti-users me-2"></i> Daftar Siswa</a></li>
                                            <li><a class="dropdown-item" href="{{ route('guru.mutabaah.calendar') }}"><i
                                                        class="ti ti-calendar me-2"></i> Monitor Harian</a></li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="row g-2 text-center mt-2">
                                    <div class="col-6">
                                        <div class="bg-light rounded-3 p-2 border border-light">
                                            ...
                                            <div class="text-muted" style="font-size: 9px; letter-spacing: 0.5px;">SISWA
                                                AKTIF</div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="bg-light rounded-3 p-2 border border-light">
                                            <div class="h5 mb-0 fw-bold text-secondary">
                                                {{ $class->students_count - $class->active_students }}</div>
                                            <div class="text-muted" style="font-size: 9px; letter-spacing: 0.5px;">TIDAK
                                                AKTIF</div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <li class="list-group-item d-flex align-items-center px-4 py-3 border-0">
                                ...
                                <div class="text-end">
                                    <div class="fw-bold text-success" style="font-size: 12px;">
                                        {{ $student->mutabaah_count }} Hari</div>
                                    <div class="small text-muted" style="font-size: 10px;">🔥 {{ $student->streak }} Hari
                                    </div>
                                </div>
                            </li>
                        @empty
                            ...
                            <div class="list-group-item px-4 py-3 border-0 border-bottom">
                                <div class="d-flex w-100 justify-content-between align-items-center mb-1">
                                    ...
                                    <small class="text-muted"
                                        style="font-size: 10px;">{{ $activity->created_at->diffForHumans() }}</small>
                                </div>
                                <p class="mb-0 small text-muted">Baru saja mengisi mutabaah harian untuk kelas <span
                                        class="text-primary fw-bold">{{ $activity->student->kelas }}</span></p>
                            </div>
                        @empty
