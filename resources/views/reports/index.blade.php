                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('reports.mutabaah.export') }}" method="GET" class="d-inline">
                            <div class="row g-2 mb-2">
                                ...
                                <div class="col-md-6">
                                    <input type="date" name="end_date" class="form-control form-control-sm" value="{{ now()->endOfMonth()->format('Y-m-d') }}">
                                </div>
                            </div>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $student->kelas }}</td>
                        <td>
                            <form action="{{ route('reports.student.pdf', $student->id) }}" method="GET" class="d-inline">
                                <input type="date" name="start_date" class="form-control form-control-sm d-inline-block" style="width: 140px;" value="{{ now()->startOfMonth()->format('Y-m-d') }}">
                                <input type="date" name="end_date" class="form-control form-control-sm d-inline-block" style="width: 140px;" value="{{ now()->endOfMonth()->format('Y-m-d') }}">
                                <button type="submit" class="btn btn-danger btn-sm">
