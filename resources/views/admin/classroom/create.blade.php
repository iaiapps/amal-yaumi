...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('guru.classroom.store') }}" method="POST">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <select name="tingkat" class="form-select @error('tingkat') is-invalid @enderror" required>
                        ...
                        <option value="II" {{ old('tingkat') == 'II' ? 'selected' : '' }}>II</option>
                        <option value="III" {{ old('tingkat') == 'III' ? 'selected' : '' }}>III</option>
                        <option value="IV" {{ old('tingkat') == 'IV' ? 'selected' : '' }}>IV</option>
                        <option value="V" {{ old('tingkat') == 'V' ? 'selected' : '' }}>V</option>
                        <option value="VI" {{ old('tingkat') == 'VI' ? 'selected' : '' }}>VI</option>
