                ...
                <div class="flex-grow-1">
                    ...
                    <ul class="mb-0">
                        ...
                        <li>
                            ...
                            <a href="{{ route('student.show', $student->id) }}" class="btn btn-sm btn-outline-warning ms-2">
        ...
        <div class="card bg-success text-white">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        <h6 class="mb-0 text-white">Siswa Aktif</h6>
                        <h2 class="mb-0 text-white">{{ $activeStudents }}</h2>
                        <small class="text-white">{{ $totalStudents > 0 ? round(($activeStudents/$totalStudents)*100, 1) : 0 }}%</small>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card bg-warning text-white">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        <h6 class="mb-0 text-white">Completion Rate</h6>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        ...
                        <small class="text-white">hari bulan ini</small>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-{{ $class->completion_rate >= 80 ? 'success' : ($class->completion_rate >= 60 ? 'warning' : 'danger') }}">
