    ...
    <div class="col-12 mb-3">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div>
                    <span class="badge bg-success me-1">🟢 Lengkap (10+)</span>
                    <span class="badge bg-warning me-1">🟡 Sebagian (5-9)</span>
                    <span class="badge bg-orange text-white me-1" style="background-color: #fd7e14;">🟠 Sedikit (1-4)</span>
                    ...
                    <table class="table table-bordered text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                    ...
                                    <td class="p-3 {{ $day['isToday'] ? 'border-primary border-3' : '' }}" 
                                        ...
                                        <div class="d-flex flex-column align-items-center justify-content-center h-100">
                                            ...
                                            @if(!$day['isFuture'])
                                                ...
                                                @endif
                                            @else
                                                <div class="text-muted" style="width: 40px; height: 40px;"></div>
                                            @endif
                                        </div>
                                    </td>
                                @endforeach
                                ...
                                @php
                                    $lastDayOfWeek = \Carbon\Carbon::parse($calendarData[count($calendarData)-1]['date'])->dayOfWeek;
